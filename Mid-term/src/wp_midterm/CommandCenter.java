...
class CommandCenter extends Building{
	...
	public CommandCenter() {	// CommandCenter의 생성자
		super("CommandCenter",1500, 1);		// buildingName로 CommandCenter, buildingHp값으로 1500, armor값으로 1을 저장(Building class의 생성자를 이용)
	}
